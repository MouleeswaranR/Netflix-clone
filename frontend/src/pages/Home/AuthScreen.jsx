  ...
  return (
    <div className='hero-bg relative '>
        ...
        <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
            ...
            <p className='mb-4'>Ready to watch? Enter your email to create aor restart your membership.</p>
        ...
        <div className='p-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                <div className='flex-1 text-center md:text-left '>
                    <h2 className='text-4xl md:text-5xl font-extarbold mb-4'>Enjoy on your TV</h2>
                    <p className='text-lg md:text-xl'>Watch on Smart TVs, PlayStation, Xbox,Chromecast,Apple TV, Blu-ray players, ans more.
                    </p>
                </div>
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                <div className='flex-1  '>
                    <div className='relative '>
                        ...
                        <div className='flex h-24 items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 border border-slate-500 rounded-md px-2'>
        ...
        <div className='p-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                <div className='flex-1 text-center md:text-left '>
                <h2 className='text-4xl md:text-5xl font-extarbold mb-4'>Watch everwhere</h2>
                    <p className='text-lg md:text-xl'>Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV.
                    </p>                
                </div>
